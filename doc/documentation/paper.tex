...
Therefore it supports Bindersplitting, Backjumping and all other features already implemented in gringo1.0.\cite{gringopaper}
...
A normal logic program $\Pi$ over $\mathcal{L(P,F,C)}$ is a finite set of rules over $\mathcal{L(P,F,C)}$.
